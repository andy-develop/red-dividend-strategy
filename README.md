...
中证红利低波动全收益指数（H20269）v7.7 策略的实时监控产品：
...
## 统一回测引擎（backtest/engine.py，v7.7 口径）
...
**回测结果（v7.7，2016-09-08 ~ 2026-09-08，初始 10 万）**：
策略 **+148.0% / 夏普 0.61 / 最大回撤 −32.5%**；买入持有 +134.3% / 0.62 / −27.5%。55 笔、总成本（费+滑点+利息）13,033 元；抄底 27 档胜率 70.4%。
